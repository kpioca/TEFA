...
{
  /// <summary> Simulates a failure in the color channels. </summary>
  public static class RGBGlitch
  {
    /// <summary> Channel displacement force, default 0.1 [0.0 - 1.0]. </summary>
    /// <returns>Value.</returns>
    public static readonly FloatRangeVariable Amplitude = new("_Amplitude", 0.1f, 0.0f, 1.0f);

    /// <summary> Channel displacement velocity, default 0.5 [0.0 - 2.0]. </summary>
    /// <returns>Value.</returns>
    public static readonly FloatPositiveVariable Speed = new("_Speed", 0.5f);
