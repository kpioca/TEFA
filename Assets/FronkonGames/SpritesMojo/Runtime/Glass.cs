...
{
  /// <summary> Simulates a glass material. </summary>
  public static class Glass
  {
    /// <summary> Glass distortion, default 25.0 [0.0 - 100.0]. </summary>
    /// <returns>Value.</returns>
    public static readonly FloatPositiveVariable Distortion = new("_Distortion", 25.0f);

    /// <summary> Glass refraction, default 10.0 [0.0 - 100.0]. </summary>
    /// <returns>Value.</returns>
    public static readonly FloatPositiveVariable Refraction = new("_Refraction", 10.0f);
