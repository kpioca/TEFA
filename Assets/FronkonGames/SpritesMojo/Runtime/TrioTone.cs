...
{
  /// <summary> Apply a three color gradient based on lightness. </summary>
  public static class TrioTone
  {
    /// <summary> Brighter color. </summary>
    /// <returns>Value.</returns>
    public static readonly ColorVariable BrightColor = new("_BrightColor", Color.white);

    /// <summary> Color for medium brightness. </summary>
    /// <returns>Value.</returns>
    public static readonly ColorVariable MiddleColor = new("_MidColor", Color.white * 0.5f);

    /// <summary> Darker color. </summary>
    /// <returns>Value.</returns>
    public static readonly ColorVariable DarkColor = new("_DarkColor", Color.black);

    /// <summary> Threshold between the two colors, default 0.25 [0.0 - 1.0]. </summary>
    /// <returns>Value.</returns>
    public static readonly FloatRangeVariable Threshold = new("_Threshold", 0.25f, 0.0f, 1.0f);
