...
namespace FronkonGames.SpritesMojo
{
  ...
  /// Float variable.
  /// </summary>
  public class FloatVariable : MaterialVariable<float>
  {
    /// <summary>
    /// Constructor.
    /// </summary>
    ...
    public FloatVariable(string variable, float reset) : base(variable, reset) { }
    ...
    public override float Get(Material material) => material.GetFloat(nameID);
  }
}
