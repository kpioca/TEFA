...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Shader "Fronkon Games/Sprites Mojo/Trio Tone"
{
  Properties
  {
    ...
    // TrioTone.
    _Threshold("", Range(0.0, 1.0)) = 0.25
    _Softness("", Range(0.0, 1.0)) = 0.25
    _BrightColor("", Color) = (1.0, 1.0, 1.0, 1.0)
    _MidColor("", Color) = (0.5, 0.5, 0.5, 1.0)
    _DarkColor("", Color) = (0.0, 0.0, 0.0, 1.0)
  ...
  CustomEditor "FronkonGames.SpritesMojo.Editor.TrioToneSpriteGUI"
