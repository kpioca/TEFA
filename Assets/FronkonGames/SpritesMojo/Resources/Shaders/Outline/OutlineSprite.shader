...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Shader "Fronkon Games/Sprites Mojo/Outline"
{
  Properties
  {
    ...
    // Outline.
    _OutlineMode("", Float) = 0
    _OutlineSize("", Range(0.0, 50.0)) = 5.0
    _AlphaThreshold("", Range(0.0, 0.99)) = 0.0
    _OutlineEmission("", Range(0.0, 10.0)) = 0.0
    _OutlineColor0("", Color) = (1.0, 1.0, 1.0, 1.0)
    _OutlineColor1("", Color) = (1.0, 1.0, 1.0, 1.0)
    _GradientScale("", Range(-10.0, 10.0)) = 1.0
    _GradientOffset("", Range(-10.0, 10.0)) = 0.0
    _OutlineTex("Outline (RGB)", 2D) = "white" {}
    _OutlineTexVel("", Vector) = (0.0, 0.0, 0.0, 0.0)
    _OutlineTexScale("", Range(0.0, 5.0)) = 1.0
    _OutlineTexAngle("", Range(0.0, 4.0)) = 0.0
  }
  ...
  SubShader
  {
    ...
    Pass
    {
      ...
      #pragma multi_compile _ OUTLINE_SOLID OUTLINE_GRADIENT OUTLINE_TEXTURE
      #pragma multi_compile _ GRADIENT_VERTICAL
  ...
  CustomEditor "FronkonGames.SpritesMojo.Editor.OutlineSpriteGUI"
