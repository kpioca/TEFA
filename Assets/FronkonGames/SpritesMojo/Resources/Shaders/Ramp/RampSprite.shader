...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Shader "Fronkon Games/Sprites Mojo/Ramp"
{
  Properties
  {
    ...
    // Ramp.
    _RampColor0("", Color) = (0.0, 0.0, 0.0, 1.0)
    _RampColor1("", Color) = (0.25, 0.25, 0.25, 1.0)
    _RampColor2("", Color) = (0.5, 0.5, 0.5, 1.0)
    _RampColor3("", Color) = (0.75, 0.75, 0.75, 1.0)
    _RampColor4("", Color) = (1.0, 1.0, 1.0, 1.0)
    _LumRangeMin("", Range(0.0, 1.0)) = 0.0
    _LumRangeMax("", Range(0.0, 1.0)) = 1.0
    _InvertRamp("", Float) = 0.0
  }
  ...
  SubShader
  {
    ...
    Pass
    {
      ...
      #pragma multi_compile _ INVERT_RAMP
  ...
  CustomEditor "FronkonGames.SpritesMojo.Editor.RampSpriteGUI"
