...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Shader "Fronkon Games/Sprites Mojo/Black And White"
{
  Properties
  {
    ...
    _Exposure("Exposure", Range(0.0, 50.0)) = 1.0
    _Red("Red", Range(0.0, 1.0)) = 0.9
    _Green("Green", Range(0.0, 1.0)) = 0.4
    _Blue("Blue", Range(0.0, 1.0)) = 0.9
  }
  ...
  CustomEditor "FronkonGames.SpritesMojo.Editor.BlackAndWhiteSpriteGUI"
