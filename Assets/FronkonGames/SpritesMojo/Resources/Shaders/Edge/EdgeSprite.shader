...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Shader "Fronkon Games/Sprites Mojo/Edge"
{
  Properties
  {
    ...
    // Edge.
    _EdgeTint("Egde tint", Color) = (1.0, 1.0, 1.0, 1.0)
    _EdgeMode("", Int) = 1
    _SobelFunction("", Float) = 3
    _Blend("Blend", Int) = 0
  }
  ...
  SubShader
  {
    ...
    Pass
    {
      ...
      #pragma multi_compile _ SOBEL_PREWITT SOBEL_ROBERTS_CROSS SOBEL_SCHARR
  ...
  CustomEditor "FronkonGames.SpritesMojo.Editor.EdgeSpriteGUI"
