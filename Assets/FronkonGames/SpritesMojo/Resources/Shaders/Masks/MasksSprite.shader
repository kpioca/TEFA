...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Shader "Fronkon Games/Sprites Mojo/Masks"
{
  Properties
  {
    ...
    _MaskRedStrength("", Range(0.0, 1.0)) = 1.0
    _RedBlendOp("Red blend color op", Int) = 13
    _MaskRedTint("", Color) = (1.0, 1.0, 1.0, 1.0)
    _MaskRedVel("", Vector) = (0.0, 0.0, 0.0, 0.0)
    _MaskRedScale("", Range(0.0, 5.0)) = 1.0
    _MaskRedAngle("", Range(0.0, 4.0)) = 0.0
    
    _MaskGreenTex("Mask (RGB)", 2D) = "white" {}
    _MaskGreenStrength("", Range(0.0, 1.0)) = 1.0
    _GreenBlendOp("Green blend color op", Int) = 13
    _MaskGreenTint("", Color) = (1.0, 1.0, 1.0, 1.0)
    _MaskGreenVel("", Vector) = (0.0, 0.0, 0.0, 0.0)
    _MaskGreenScale("", Range(0.0, 5.0)) = 1.0
    _MaskGreenAngle("", Range(0.0, 4.0)) = 0.0
    
    _MaskBlueTex("Mask (RGB)", 2D) = "white" {}
    _MaskBlueStrength("", Range(0.0, 1.0)) = 1.0
    _BlueBlendOp("Blue blend color op", Int) = 13
    _MaskBlueTint("", Color) = (1.0, 1.0, 1.0, 1.0)
    _MaskBlueVel("", Vector) = (0.0, 0.0, 0.0, 0.0)
    _MaskBlueScale("", Range(0.0, 5.0)) = 1.0
    _MaskBlueAngle("", Range(0.0, 4.0)) = 0.0
  }
  ...
  CustomEditor "FronkonGames.SpritesMojo.Editor.MasksSpriteGUI"
