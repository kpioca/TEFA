...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Shader "Fronkon Games/Sprites Mojo/Hologram"
{
  Properties
  {
    ...
    _BlinkStrength("Blink strength", Float) = 0.03
    _BlinkSpeed("Blink speed", Float) = 50.0
    _ScanlineStrength("Scanline strength", Float) = 0.1
    _ScanlineCount("Scanline count", Float) = 10.0
    _ScanlineSpeed("Scanline speed", Float) = 10.0
    _Tint("Tint", Color) = (0.95, 1.05, 0.95, 1.0)
  }
  ...
  CustomEditor "FronkonGames.SpritesMojo.Editor.HologramSpriteGUI"
