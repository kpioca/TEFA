...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Shader "Fronkon Games/Sprites Mojo/Dither"
{
  Properties
  {
    ...
    // Dither.
    _DitheringTex("", 2D) = "white" {}
    _Dithering("", Float) = 0
    _PaletteSpace("", Range(0.0, 1.0)) = 0.125
    _Pixelation("", Range(1.0, 25.0)) = 4.0
  }
  ...
  SubShader
  {
    ...
    Pass
    {
      ...
      #pragma multi_compile _ DITHERING_BAYER4x4 DITHERING_BAYER8x8 DITHERING_NOISE
  ...
  CustomEditor "FronkonGames.SpritesMojo.Editor.DitherSpriteGUI"
