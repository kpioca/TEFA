...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Shader "Fronkon Games/Sprites Mojo/Dissolve"
{
  Properties
  {
    ...
    // Dissolve.
    _DissolveSlide("", Range(0.0, 1.0)) = 1.0
    _DissolveTex("", 2D) = "white" {}
    _DissolveShape("", Float) = 0.0
    _DissolveInverse("", Float) = 0.0
    _DissolveUVScale("", Range(0.1, 5.0)) = 1.0
    _DissolveBorderSize("", Range(0.0, 50.0)) = 5.0
    _DissolveBorderColorInside("", Color) = (1.0, 1.0, 1.0, 1.0)
    _DissolveBorderColorOutside("", Color) = (1.0, 1.0, 1.0, 1.0)
    _DissolveBorderTex("", 2D) = "white" {}
    _DissolveBorderTexUVScale("", Range(0.1, 5.0)) = 1.0
  }
  ...
  SubShader
  {
    ...
    Pass
    {
      ...
      #pragma multi_compile _ DISSOLVE_NORMAL DISSOLVE_COLOR DISSOLVE_TEXTURE
  ...
  CustomEditor "FronkonGames.SpritesMojo.Editor.DissolveSpriteGUI"
