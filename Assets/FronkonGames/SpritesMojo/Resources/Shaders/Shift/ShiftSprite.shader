...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Shader "Fronkon Games/Sprites Mojo/Shift"
{
  Properties
  {
    ...
    // Shift.
    [MaterialToggle] LINEAR_SHIFT("Use linear", Float) = 1
    [MaterialToggle] RADIAL_SHIFT("Use radial", Float) = 0
    [MaterialToggle] NOISE("Use noise", Float) = 0
    _NoiseStrength("Noise strength", Range(0.0, 1.0)) = 0.0
    _NoiseSpeed("Noise speed", Range(0.0, 1.0)) = 0.5
    _RadialShift("Radial strength", Float) = 0.0
    _RedShift("Red shift", Vector) = (0.0, 0.0, 0.0, 0.0)
    _GreenShift("Green shift", Vector) = (0.0, 0.0, 0.0, 0.0)
    _BlueShift("Blue shift", Vector) = (0.0, 0.0, 0.0, 0.0)
  }
  ...
  SubShader
  {
    ...
    Pass
    {
      ...
      #pragma multi_compile _ LINEAR RADIAL
  ...
  CustomEditor "FronkonGames.SpritesMojo.Editor.ShiftSpriteGUI"
