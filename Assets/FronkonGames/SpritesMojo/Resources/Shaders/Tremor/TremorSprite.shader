...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Shader "Fronkon Games/Sprites Mojo/Tremor"
{
  Properties
  {
    ...
    // Tremor.
    _Velocity("Velocity", Range(0.0, 10.0)) = 1.0
    _NoiseScale("Noise scale", Range(0.0, 1.0)) = 0.1
    _NoiseSnap("Noise snap", Range(0.0, 10.0)) = 0.5
  }
  ...
  CustomEditor "FronkonGames.SpritesMojo.Editor.TremorSpriteGUI"
