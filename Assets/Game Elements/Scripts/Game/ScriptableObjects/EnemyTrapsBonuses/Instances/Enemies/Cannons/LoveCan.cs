...
public class LoveCan : Cannon
{
    ...
    public override void Attack(GameObject[] markGun, float platformsSpeed, Vector3 target, MonoBehaviour toUseCoroutines = null)
    {
        ...
        MoveToPos(toUseCoroutines, bullet, target + bullet.transform.forward * 2 + Vector3.up, bulletsInfo[0], platformsSpeed);
    }
    ...
    private protected override IEnumerator MovementCoroutine(GameObject obj, Vector3 target, float speed)
    {
